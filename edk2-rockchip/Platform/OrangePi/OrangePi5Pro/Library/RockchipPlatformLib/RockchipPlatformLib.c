...
static struct regulator_init_data rk806_init_data[] = {
  ...
  RK8XX_VOLTAGE_INIT (MASTER_BUCK2,  850000),
...
{
  /* Green status LED (GPIO1_PC2, active-high via PWM_LEDG transistor) */
  GpioPinWrite (1, GPIO_PIN_PC2, FALSE);
...
{
  GpioPinWrite (1, GPIO_PIN_PC2, Enable);
}
  ...
  )
{
  STATIC CONST EFI_GUID  VendorDtbFileGuid = {
    ...
    0x0f734439, 0x7bb7, 0x11ef, { 0xb2, 0x5a, 0x00, 0x16, 0x3e, 0x21, 0xee, 0x39 }
  };
  STATIC CONST EFI_GUID  MainlineDtbFileGuid = {
    // DeviceTree/Mainline.inf FILE_GUID
    0x0f73443a, 0x7bb7, 0x11ef, { 0xb2, 0x5a, 0x00, 0x16, 0x3e, 0x21, 0xee, 0x3a }
  };
